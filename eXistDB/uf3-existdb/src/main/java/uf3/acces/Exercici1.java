...
public class Exercici1 {
    ...
    // Creem el metode per afegir una nova ordre amb XPath
    ...
    public static void deleteComanda() throws Exception{
        // Cal recalcar que per a fer referencia a un atribut s'ha de posar [@atribut='']
    ...
    // Fem un metode que cambi la quantitat de items del ordre 1 a 5
    ...
    // Amb replacer cambiem la Ciutat, L'estat i el Zip de l'ordre 3
    ...
    // Amb l'ordre insert, posem directament l'atribut Priority a dintre de l'ordre 3
    ...
    // Creem un metode per a calcular el cost total de les ordres
